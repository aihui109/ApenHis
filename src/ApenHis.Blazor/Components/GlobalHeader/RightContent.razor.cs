...
namespace ApenHis.Blazor.Components
{
    public partial class RightContent
    {
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            SetClassMap();
            _notifications = new List<NoticeIconData> { new NoticeIconData {  Key="1", Title="1"} } .ToArray();
            _messages = new List<NoticeIconData> { new NoticeIconData { Key = "2", Title = "2" } }.ToArray();
            _events = new List<NoticeIconData> { new NoticeIconData { Key = "3", Title = "3" } }.ToArray();
            _count = 3;
        }
