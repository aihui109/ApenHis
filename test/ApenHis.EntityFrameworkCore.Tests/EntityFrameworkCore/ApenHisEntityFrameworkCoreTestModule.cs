...
[DependsOn(
    ...
    typeof(ApenHisTestBaseModule),
    typeof(AbpEntityFrameworkCoreSqliteModule)
    )]
public class ApenHisEntityFrameworkCoreTestModule : AbpModule
{
    ...
    private static SqliteConnection CreateDatabaseAndGetConnection()
    {
        ...
        var options = new DbContextOptionsBuilder<ApenHisDbContext>()
            .UseSqlite(connection)
            .Options;

        using (var context = new ApenHisDbContext(options))
        {
